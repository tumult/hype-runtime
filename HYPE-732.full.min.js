...
(function(){v.HYPE_732F=function(R,J,Ma,je,pj,qj,Ua,A,lc,gq,pd,ef,ga,rj,Dg,ff,hq,iq,jq,ke){function gf(a){var b=zb(a);if(!(ga!=h||a==k||0<Hb||b==k||b.nb==h))if(b=b.Qa[M[a.id]],b!=k){var c=1==n(a,cl,0),d=n(a,kl,0.5),e=n(a,ll,0.1),f=n(a,Pl,0.01);a=n(a,ml,0.001);0>=a&&(a=1E-6);c==h&&(d=0,e=1,a=Infinity);b.restitution=d;b.friction=e;b.frictionAir=f;c!=h&&B.Body.setDensity(b,a)}}function mc(a,b){var c,d,e,f=zb(a);if(!(ga!=h||a==k||0<Hb||f==k||f.nb==h)){var g=f.oa.world,j=M[a.id],m=f.Qa[j],l=n(a,cl,0);
...
f.open(Ch,e,h);f.responseType=oj;f.onload=function(){b.Oa=p;b.Ba=h;b.Cb=f.response;a!=k&&a(b);b.Za==h&&b[ub]()};f.onerror=function(){b.Oa=p;d!=k&&d(b)};try{f.send()}catch(g){}}}};ra(b,function(){b.Mb();var a=v.HYPE_gac_732;a==k&&(a=new (v.AudioContext||v.webkitAudioContext),v.HYPE_gac_732=a);a.resume!=k&&a.resume();b.source=a.createBufferSource();b[Ac].connect(a.destination);ta(b[Ac],b.loop);b[xc].Fb==h&&b.tb();b.Ba!=h?(b.Za=h,b.load()):b.Cb!=k?(a.decodeAudioData(b.Cb,function(a){b.ec=a;b[Ac].buffer=
...
opacity:{HYP_r:Hm,HYP_s:1}},qb=0,U=0,sb=[],Ob=[],rb={},cb={},Bd={},pc={},ca={},Af=p,Hd={},Zb=[],mh=p,aa={},fh={},Ae=[],Jd={},we=k,Cf=k,Yb={},M={},uh={},Lk=0,Ff=p,Of=[],ah={},Ad={},Ek=p,Jc=p,lf=p,$g=p,te=[],Kc={},Jf={},qh={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Id=p,rh=p,pe=v.HYPE_w_732,sf=[],sh=p,zf=k;da.xb=Uf;da.wa=Re;da.ob=Go;var Be=p,Kf=0,Lf=p,ze=[];da.z_o=function(){0==Lk&&(Lk=th());ef!=k&&ef(h,S);ff=ff&&F.xa!=k;F.Na!=k&&w[yb][ab](Cp,fq(),F.Gb?{passive:p}:
...
triggerCustomBehaviorNamed:Rj,getSymbolInstanceById:function(b){if(b!=k)return pc[M[b]]},getSymbolInstancesByName:qk}};v.HYPE==k&&(v.HYPE=v.HYPE_732F,v.HYPE.documents={});var R=[];v.HYPE_dtl_732F!=k&&(R=v.HYPE_dtl_732F[tb](0));v.HYPE_dtl_732F=[];for(var J=0;J<R[W];J++)R[J]()})();})();
