...
(function(){v.HYPE_644F=function(O,J,Ka,fe,sj,tj,Sa,I,lc,bq,qd,bf,fa,uj,Bg,cf,cq,dq,eq,ge){function df(a){var b=yb(a);if(!(fa!=h||a==k||0<Eb||b==k||b.nb==h))if(b=b.Pa[P[a.id]],b!=k){var c=1==n(a,al,0),d=n(a,il,0.5),e=n(a,jl,0.1),f=n(a,Nl,0.01);a=n(a,kl,0.001);0>=a&&(a=1E-6);c==h&&(d=0,e=1,a=Infinity);b.restitution=d;b.friction=e;b.frictionAir=f;c!=h&&A.Body.setDensity(b,a)}}function mc(a,b){var c,d,e,f=yb(a);if(!(fa!=h||a==k||0<Eb||f==k||f.nb==h)){var g=f.oa.world,j=P[a.id],l=f.Pa[j],m=n(a,al,0);
...
b.Cb=f.response;a!=k&&a(b);b.Za==h&&b[tb]()};f.onerror=function(){b.Na=p;d!=k&&d(b)};try{f.send()}catch(g){}}};sa(b,function(){b.Mb();var a=v.HYPE_gac_644;a==k&&(a=new (v.AudioContext||v.webkitAudioContext),v.HYPE_gac_644=a);a.resume!=k&&a.resume();b.source=a.createBufferSource();b[zc].connect(a.destination);ta(b[zc],b.loop);b[wc].Fb==h&&b.tb();b.Ba!=h?(b.Za=h,b.load()):b.Cb!=k?(a.decodeAudioData(b.Cb,function(a){b.ec=a;b[zc].buffer=a;b[wc].Fb!=h&&b.tb()}),b.Cb=k):(b[zc].buffer=b.ec,b[wc].Fb!=h&&
...
rb={},cb={},Cd={},pc={},ha={},wf=p,Hd={},Zb=[],lh=p,aa={},dh={},we=[],Jd={},re=k,yf=k,Yb={},P={},uh={},Kk=0,Bf=p,Lf=[],Zg={},Bd={},Fk=p,Lc=p,hf=p,Yg=p,pe=[],Mc={},Gf={},ph={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Id=p,qh=p,le=v.HYPE_w_644,pf=[],rh=p;ca.xb=Tf;ca.wa=Qe;ca.ob=Bo;var xe=p,Hf=0,If=p,ve=[];ca.z_o=function(){0==Kk&&(Kk=th());bf!=k&&bf(h,U);cf=cf&&E.xa!=k;E.Ma!=k&&w[xb][$a](xp,aq(),E.Gb?{passive:p}:p);Yb[J]=J;P[J]=J;uh[J]=J;for(var a=0;a<I[X];a++){var b=
...
b=p;c=la(c);c!=k&&(b=c.fa);return b},triggerCustomBehaviorNamed:Uj,getSymbolInstanceById:function(b){if(b!=k)return pc[P[b]]},getSymbolInstancesByName:rk}};v.HYPE==k&&(v.HYPE=v.HYPE_644F,v.HYPE.documents={});var O=[];v.HYPE_dtl_644F!=k&&(O=v.HYPE_dtl_644F[mb](0));v.HYPE_dtl_644F=[];for(var J=0;J<O[X];J++)O[J]()})();})();
