...
(function(){v.HYPE_758F=function(R,J,Oa,je,sj,tj,Va,A,lc,mq,pd,ef,fa,uj,Dg,ff,nq,oq,pq,ke){function gf(a){var b=zb(a);if(!(fa!=h||a==k||0<Ib||b==k||b.ob==h))if(b=b.Qa[M[a.id]],b!=k){var c=1==n(a,il,0),d=n(a,ql,0.5),e=n(a,rl,0.1),f=n(a,Vl,0.01);a=n(a,sl,0.001);0>=a&&(a=1E-6);c==h&&(d=0,e=1,a=Infinity);b.restitution=d;b.friction=e;b.frictionAir=f;c!=h&&B.Body.setDensity(b,a)}}function mc(a,b){var c,d,e,f=zb(a);if(!(fa!=h||a==k||0<Ib||f==k||f.ob==h)){var g=f.oa.world,j=M[a.id],m=f.Qa[j],l=n(a,il,0);
if(!(0==l&&m==k)){Ib+=1;var q=m!=k&&0==l;(m==k&&0!=l)==h?(m=vj(a),m=wj(a,m,h),m==k&&(m=B.Body[Ha]({elementId:a.id})),m.plugin=n(a,Om,{}),B.Composite.add(g,m),f.Qa[j]=m):q==h&&(B.Composite.remove(g,m),V(a,Om,m.plugin),delete f.Qa[j],m=k);f=n(a,ql,0.5);g=n(a,rl,0.1);j=n(a,Vl,0.01);q=n(a,sl,0.001);0>=q&&(q=1E-6);1==l&&(f=0,g=1,q=Infinity);xj(a);var t=M[a.id];d=n(a,wp,0.5);c=n(a,xp,0.5);e=nb(t,h);t=ob(t,h);d*=e;c*=t;e=hf(a);d=qd(e,[d,c]);c=d[0];d=d[1];e=r.PI*((da(n(a,Ym,0))-da(n(a,xm,0)))/180);var t=
...
36),c=Yg(a),d=M[a.id],e=me(d),f=jf(e),g=Hg(e),j=jf(d),m=n(a,Vi,0),l=n(a,Yk,0),q=n(a,Hl,k),t=n(a,im,k),u=e=h;q==k&&(e=p,q=j[G]);t==k&&(u=p,t=j[L]);var s=nb(d),x=ob(d),y=x-t,j=m,C=l,T=s,D=x,N=p;if(Jc==h&&36!=b){var O=0!=(b&1),na=0!=(b&4),A=0!=(b&2),B=0!=(b&8),J=0!=(b&32),E=0!=(b&16),Q=0!=(b&64)&&A==h&&E==h,U=0!=(b&128)&&A==h&&E==h,N=0!=(b&256)&&(A==h||E==h),S=0==f[G]?0:g[G]/f[G],P=0==f[L]?0:g[L]/f[L];A==h&&(T=O==h&&na==h?s+(g[G]-f[G]):r[Cb](s*S));O==h&&na==h&&A==p?(b=m+s/2,j=r[Cb](b*S-s/2)):O==h&&na==
...
2==pd[t].p)u=s;else if(e!=ba){d=ah[e];if(a.b!=k){if(c.rb[e]==k&&(d=a.o,l=a.a,l!=ba)){q=ah[l];a={};t=[];for(f=x=C=0;f<q.va[X];f++){y=q.va[f];if(0==f)var C=nb(d),x=ob(d),T=aa[d].b,C=aa[d].a+C/2-y.sa.x,x=T+x/2-y.sa.y;t[z]({sa:{x:y.sa.x+C,y:y.sa.y+x},La:{x:y.La.x+C,y:y.La.y+x},Ha:{x:y.Ha.x,y:y.Ha.y},Ia:{x:y.Ia.x,y:y.Ia.y},length:0,ea:[]});x=C=0}a.va=t;xa(a,rf(a.va,h));c.rb[l]=a;l=ka(d);if(n(l,ll)==Pi){for(var D,l=0;l<c.ra[X];l++)if(q=c.ra[l],q.i==kl){D=q;break}D!=k&&(a=ck(a,0,d),D.b=a.Ra)}}d=c.rb[e]}c=
...
b){for(var c=a.ra,d=0;d<c[X];d++){var e=c[d],f=e.o,g=e.i,e=Da(Ob(e,a)+e.d,a);rb[f]===ba&&(rb[f]={});if(e>=b&&(cb[f]===ba||cb[f][g]===ba||cb[f][g]==a.ca))rb[f][g]=a.ca}jk(a)}function Lb(a,b,c){Bf(a);for(var d=0;d<sb[X];d++){var e=sb[d];e.ca==a&&Dd(e)}var f=la(a);if(f!=k)if(f.sc=b,Pb[z](f),A[U].T[f.ca]==k&&f.Ab==ba&&f.Ja!=h)Ed(f);else if(a=c==p,f.Ja!=h&&(dh(f,a),Cd(f,c),eh(f,0),ik(f,0)),f.fa=h,f.Ca=0,f.Pa=0,f.qa=[],f.ya=[],f.rb={},f.ia=Bb(ba)/1E3,v[Sa](f.Da),f.Da=v[fc](function(){Ed(f)},1E3*(Ca(f)/
f.ja)),hk(f,a),f.Ja==h||0<f.ra[X]||0<f.fb[X])Mc(0,f,h,h,p),rd()}function Bf(a){var b=la(a);if(b==k||b.pa==k||b.pa.q!=h)Bd[a]=k}function dh(a,b){for(var c=0;c<a.ra[X];c++){var d=a.ra[c],e=d.o,f=d.i,g=d.r;try{if(g==h&&aa[e][f]!=k&&(b||d.b==k))d.b=aa[e][f],f==jm&&Pg(d)}catch(j){}}}function la(a){for(var b=0;b<sb[X];b++){var c=sb[b];if(c.ca==a)return c}for(var d in ha)if(ha[I](d)!=p)for(var e=ha[d].Hb,b=0;b<e[X];b++)if(c=e[b],c.ca==a)return c;return k}function qc(a){var b=A[U].T,c;for(c in b)if(b[I](c)!=
...
v[fc](function(){qa(l[H],yl);wf(f)},0);return{o:f,size:c,sE:l,cI:b,Rb:d}}function d(a,b,c){return{i:Ag,t:a,d:0,s:{a:c?c:[{p:Sg,hc:function(){vd(b,Mf,0)}}]},p:yf}}var e=va(),f=M[e.id],g=a.c,j=0==g?sc(U):tc(U),m=0==g?Vi:Yk,l=c(Co,Do,h),q=c(io,ko,p),n=fi+m,u=[],s=0;q!=k&&(fb(u,m,0,2,im,f,-1*j,0),fb(u,m,0,2,im,q.o,0,j),u[z](d(0,q.cI)),s+=2);var x=s;u[z](d(x,k,[{p:7,b:n},{p:Sg,hc:b}]));l!=k&&(fb(u,m,s,2,Nm,f,0,j),f=-1*l.size,fb(u,m,s,2,Nm,l.o,f,f+j),s+=2,u[z](d(s,l.cI)));we(n,u,{i:n,n:n,f:30,d:s,a:u,b:[],
...
(Ae=h);if(c.ga!=k)for(e=0;e<c.ga[X];e++){q=c.ga[e].b;t=la(q);Mb(q,k);Cd(t,p);a.Ib=Nc(t.ca,p);for(var d=t.ra,u=0;u<d[X];u++){var s=d[u].o,x=d[u].i;cb[s]===ba&&(cb[s]={});cb[s][x]=t.ca}}c.za!=k&&(e=M[c.za.id],a.Sb=n(c.za,Ph,aa[e].a),a.Tb=n(c.za,Oh,aa[e].b),rb[e]!=ba&&(rb[e].a=k,rb[e].b=k,jk(k)),cb[e]===ba&&(cb[e]={}),cb[e].a=Pm,cb[e].b=Pm,fa==h&&mc(c.za));Nf(b,a)}}var d=If(a.ma?b[gc][0]:b),y=a.Sa[0];y[Ga].x=y.end.x;y[Ga].y=y.end.y;a.yb=a.Xb;y.end.x=a.ma?b[gc][0].pageX:d.x;y.end.y=a.ma?b[gc][0].pageY:
...
A=a.Sb+(y.end.x-y[zc].x)/C,y=a.Tb+(y.end.y-y[zc].y)/T,Jc==p?(D=Hg(D),T=nb(e),A=r.max(A,-T/2-x),A=r.min(A,D[G]-T/2-x),e=ob(e),y=r.max(y,-e/2-s),y=r.min(y,D[L]-e/2-s)):(D=Aj(c.za,A,y),A=D.x,y=D.y),c=c.za,W(c,Vi,A,Yk,y),fa==h&&(Jg(c,Vi,A,u/1E3),Jg(c,Yk,y,u/1E3),V(c,Kl,h),c=zb(c),le(c)));Nf(b,a)}else c.ka==vp?1<a.Ya?a.ta(b):(b[gb]&&a.Aa==c[Dc]&&b[gb](),A=c[Dc]==Yo||c[Dc]==On?y.end.x:y.end.y,D=p,D=c[Dc]==Yo||c[Dc]==Km?20<a.Ua-A:20<A-a.Ua,c=a.Aa===c[Dc]||100>u,(D||c==p||Ae==h)&&a.ta(b)):c.ka==zp&&5<pb(y[zc],
y.end)&&a.ta(b);xk(a,d)}};Ya(a.ma?Ip:Xn,a.Kb,b,p);a.Jb=function(b){if(!(a.Ka===Sm||a.Ka===am)&&!(b[gc]&&0<b[gc][X])){for(var c=a.Ma==w,e=va(),d=a.Ma;d!=k;){if(d==e){c=h;break}d=d[yc]}if(Lf==h&&0<Kf||c==p)a.ta(b);else{c=a[xc];b[La]==Hp&&0<b[ec][X]&&c[La]==zp&&Hf(b[ec][0]);var l=Bb(),q=l-a.lb,e=a.Sa[0];a.Aa=yk(e[zc],e.end,q);a.Ka=Sm;cb={};var d=1===a.Ya||!a.ma,n=0!==e.end.x;if(c.ka==Lm){if(a.mb==p){kh(a);return}if(c.ga!=k){d=(l-a.yb)/1E3;for(n=0;n<c.ga[X];n++){var u=c.ga[n],l=u.b,q=la(l),s=u.y;if(q){var x=
...
x-q.na:q.na,l,h,h)}}}Nf(b,a)}else c.ka==vp?(l=a.Aa===c[Dc],d=d&&n&&l,e=pb(e[zc],e.end),d&&e>c.ib?(b={type:pi+c[Dc][Hc](0).toUpperCase()+c[Dc][tb](1)+zg},a.Lb(b)):a.ta(b)):c.ka==zp?1500>q&&a.Lb(b):a.ta(b);kh(a)}}};Ya(a.ma?Hp:$n,a.Jb,b,p);b.setCapture&&b.setCapture();a.lb=Bb();a.yb=a.lb;a.mb=p;Ae=Lf=a.qb=p}}}function kh(a){if(a.wb!=h){a.wb=h;cb={};var b=a.ma?a.Ma:w;b.releaseCapture&&b.releaseCapture();Be(a.ma?Ip:Xn,a.Kb,b);Be(a.ma?Hp:$n,a.Jb,b);a.ma?Be(Gp,a.ta,b):Be(Yn,a.ta,b);a[xc].ka==Lm&&(Ae=p);
...
function(){var a=[],b;for(b in e.cb)e.cb[I](b)!=p&&a[z](b);return a.sort()}}return e}function qq(a,b){var c=Tg(a);ta(c,b);c[ub]()}function Dk(a){a=Hd[a];if(a!=k){for(var b=1<v.devicePixelRatio,c=p,d=k,e=0;e<a[X];e++){var f=a[e],g=Oa[f].t;if(g==wg)d=f,c=h;else if(g==xg){if(c==p||b==h)d=f;if(b==h)break}else c==p&&(d=f)}return d}}function lh(a,b){var c=Ia(Zb,a);-1!=c&&Zb[bb](c,1);0>=Zb[X]?Ek():b==h&&mh==p&&(mh=h,v[fc](function(){Fk()},1))}function Fk(){0>=Zb[X]||(mh=p,Gk(Zb[0],h))}function Gk(a,b){var c=
Oa[a].p;if(1==c)if(c=Oa[a].g,c!=k&&Dk(c)!=a)lh(a,b);else{var c=new Image,d=function(){lh(a,b)},e=Pc(a);c.onload=d;c.onerror=d;c.onabort=d;c.src=e;c.Ac=a}else 2==c&&(c=function(){for(var c=Hd[Oa[a].g],e=0;e<c[X];e++){var d=c[e];Oa[d].p!=k&&lh(d,b)}},d=Tg(Oa[a].g),F.Na!=k&&536.26>F.xa||9>F.$?v[fc](c,1):d.load(c,c))}function Ek(){ef!=k&&ef(p,S);if(Ab({type:ji},S)!==p)if(-1==Dg)vd(qb);else{Id=h;for(var a=-1,b=0;b<Va[X];b++){for(var c=Va[b].X,d=0;d<c[X];d++)if(c[d]==Dg){a=b;break}if(-1!=a)break}-1==a&&
(a=0);qb=a;Qf(Dg)}}function Pc(a){var b=Oa[a];if(b==k)return Z;var c=b.n;a=Z;b.r!=h&&(a+=je+bf);a+=c;b=Ab({type:li,url:a});typeof b===lp&&(a=b);return a}function Df(a){for(var b=0;b<A[X];b++)if(A[b].o==a)return b;return-1}function Oc(a){a=A[a];return a==k?k:a.o}function va(){return ka(Oc(U))}function Fd(a){if(a.getElementsByClassName)return a.getElementsByClassName(Ih);var b=/(^|\s)HYPE_element(\s|$)/;a=a||w;a=a.all?a.all:a[hb](ce);for(var c=[],d,e=a[X],f=0;f<e;f++)d=a[f],b.test(d[vc])&&c[z](d);return c}
function fb(a,b,c,d,e,f,g,j,m){a[z]({i:b,t:c,d:d,f:e,o:f,s:g,e:j,r:m,p:0})}function nh(a,b,c,d,e){b={i:a,n:a,f:30,d:b,a:c,b:[]};S[Y](Qk,h);S[Y](Rk,h);A[U].T[a]=b;we(a,c,b);Cf=a;ve=function(){gh(d,e,a,h)};Lb(a,k,p)}function Gd(a,b,c,d){var e=S[dc][Hb],f=a[kb](Nh),g=b[kb](Nh);if(aa[M[a.id]]){var j=sc(f),m=tc(f);W(a,Hl,j,im,m)}a=sc(g);g=tc(g);W(b,Hl,a,im,g);c&&(c=j,a>c&&(c=a),pa(S[H],K(c)),Kc[S.id]=k,S[H].margin==Vk&&W(b,Vi,r.max(0,(j<a?e<c?e-j:c-j:e<c?e-a:c-a)/2)));d&&(b=m,g>b&&(b=g),ua(S[H],K(b)))}
...
var j=[],q;for(q in pc)if(pc[I](q)!=p){var l=p,n;for(n in lc)if(lc[I](n)!=p){for(m=0;m<lc[n][X];m++)if(q==lc[n][m]){l=h;break}if(l==h)break}l==p&&j[z](q)}for(l=0;l<j[X];l++)delete pc[j[l]];ze=[];if(fa==h){q=[];for(n=0;n<Ea[X];n++)l=Ea[n],Mg(l)==p&&q[z](l);for(n=0;n<q[X];n++)l=Lg(q[n][wc]),l!=k&&(l=Ia(Ea,l),-1!=l&&Ea[bb](l,1))}U=Df(f);q=ka(f);n=q[kb](Nh);fa==h&&Og(k);if(F.Na!=k&&(l=va(),l!=k)){l=l[hb](Vp);for(j=0;j<l[X];j++){m=l[j];za(m,Z);var t=m.outerHTML,s=m[dc];s[Cc](m);za(s,s.innerHTML+t)}}if(pe!=
...
h||b.Oa==h)){b.Oa=h;var e=b.tc();if(e==k)d(b);else{-1==e[$b](vg)&&(e=Z+e+vg);var f=new XMLHttpRequest;f.open(Gh,e,h);f.responseType=Sk;f.onload=function(){b.Oa=p;b.Ba=h;b.Cb=f.response;a!=k&&a(b);b.$a==h&&b[ub]()};f.onerror=function(){b.Oa=p;d!=k&&d(b)};try{f.send()}catch(g){}}}};ra(b,function(){b.Mb();var a=v.HYPE_gac_758;a==k&&(a=new (v.AudioContext||v.webkitAudioContext),v.HYPE_gac_758=a);a.resume!=k&&a.resume();b.source=a.createBufferSource();b[Ac].connect(a.destination);ta(b[Ac],b.loop);b[xc].Fb==
...
100)}});ya(b,function(){if(b.ua!=k)try{b.ua.Stop()}catch(a){v[fc](function(){b[kc]()},100)}})}var ca=this,S=w[Vb](J),Sg=4,Mf=1,yf=2,Gf=[Xl,Yl],xe=[Wi,Zi,Yi,$i,Xi,jl,ej,fj,pl,Wl],kk=[Ep,kq,Dp,mn,fm,jq,ep],ok={"physics-body-type":{HYP_r:il},"physics-bounce":{HYP_r:ql,HYP_s:0.5},"physics-friction":{HYP_r:rl,HYP_s:0.1},"physics-air-drag":{HYP_r:Vl,HYP_s:0.01},"physics-density":{HYP_r:sl,HYP_s:0.001},top:{HYP_r:Yk},left:{HYP_r:Vi},width:{HYP_r:Hl},height:{HYP_r:im},"background-image":{HYP_x:h,HYP_r:$l},
rotateZ:{HYP_r:Ym,HYP_s:0},scaleX:{HYP_r:Tl,HYP_s:1},scaleY:{HYP_r:Ul,HYP_s:1},"z-index":{HYP_r:iq},opacity:{HYP_r:Nm,HYP_s:1}},qb=0,U=0,sb=[],Pb=[],rb={},cb={},Bd={},pc={},ha={},Af=p,Hd={},Zb=[],mh=p,aa={},fh={},ze=[],Jd={},ve=k,Cf=k,Yb={},M={},uh={},Ok=0,Ff=p,Of=[],ah={},Ad={},Hk=p,Jc=p,lf=p,$g=p,te=[],Kc={},Jf={},qh={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Id=p,rh=p,pe=v.HYPE_w_758,sf=[],sh=p,zf=k;ca.xb=Uf;ca.wa=Qe;ca.pb=Mo;var Ae=p,Kf=0,Lf=p,ye=[];ca.z_o=
function(){0==Ok&&(Ok=th());ef!=k&&ef(h,S);ff=ff&&F.xa!=k;F.Na!=k&&w[yb][ab](Ip,lq(),F.Gb?{passive:p}:p);Yb[J]=J;M[J]=J;uh[J]=J;for(var a=0;a<A[X];a++){var b=A[a].T,c;for(c in b)if(b[I](c)!=p){var d=b[c];d.d=Ce(d.z,d);for(var e=0;e<d.a[X];e++){var f=d.a[e];f.t=Ce(f.y,d);f.d=Ce(f.z,d);f.p==k?f.p=0:f.p==yf&&(f.d=0);f.r==k&&(f.r=p);f.k=e}e=d.b;for(f=0;f<e[X];f++){var g=e[f];g.startTime=Ce(g.C,d);g.duration=Ce(g.D,d)}}}Kk(Xe);nq==h&&Kk(Qi);for(a=0;a<sj[X];a++)b=sj[a],c=w[Sc](Jm),za(c,b),Jk(c),9>F.$&&
...
function(){if(w[C])for(var a=0;a<Ea[X];a++){var b=Ea[a];b.ca!=k&&Mb(b.ca)}else for(a=0;a<Ea[X];a++)b=Ea[a],b.ca!=k&&wd(b.ca)},p)}for(var D in Oa)Oa[I](D)!=p&&(x=Oa[D].g,x!=k&&(y=Hd[x],y==k&&(y=[],Hd[x]=y),y[z](D)));for(var E in Oa)Oa[I](E)!=p&&Oa[E].p!=k&&-1==Ia(Zb,E)&&Zb[z](E);D=Zb[tb](0);if(0==D[X])Ek();else if(9>F.$)Fk();else for(E=0;E<D[X];E++)Gk(D[E],p);v[ab]?(v[ab](To,function(){Id=p;rc()}),v[ab](vo,function(){v[fc](rc,1)})):v[Tb]&&v[Tb](to,function(){Id=p;rc()});if(ke&&(S[H][Te]=Xo,S[ab])){D=
[dm,$n,Jo,yi,Wn,Zn];for(E=0;E<D[X];E++)S[ab](D[E],sq,h)}};var F;var $a=function(a){return(a=ja&&ja[Ka]&&ja[Ka].match(a))&&a[1]},Q={};if(ja){if(ja.userAgentData!=k)for(var vh=ja.userAgentData.brands,Rf=0;Rf<vh[X];Rf++)if(-1!=vh[Rf].brand[$b](Ah)){Q.Wa=da(vh[Rf].version);Q.xa=537.36;break}Q.Wa==k&&(Q.$=da($a(/MSIE (\d+\.\d+)/))||da($a(/(Trident)/)&&$a(/rv:(\d+\.\d+)/))||da($a(/Edge\/(\d+\.\d+)/))||k,Q.lc=da($a(/Gecko\/(\d+)/))||k,Q.Xa=da($a(/Firefox\/(\d+\.\d+)/))||k,Q.xa=da(!Q.$&&$a(/AppleWebKit\/(\d+\.\d+)/))||
...
K(b)},Y:function(a,b){a[H].lineHeight=K(b)},aX:Wj,aW:Wj,f:oc,bR:zd,aY:zd,cQ:oc,cR:oc,gW:oc,uB:oc,tX:oc,tY:oc,bO:oc,bP:nc,e:function(a,b){if(9>F.$||F.$!=k&&F.Yb){if(1==ea(b))V(a,Uh,Z),V(a,Th,Z);else{var c=Bg+r[Gb](100*b)+ae;V(a,Uh,ca.pb+Ve+c);V(a,Th,c[Fc]());a[H].backgroundColor==Z&&a[H].backgroundImage==Z&&w[Vb](En+a.id)==k&&oa(a[H],Rp+xf(Pc(Ge))+Rd)}se(a)}a[H].opacity=b;a[H].MozOpacity=b;Xj(a)},aP:function(a,b){a[H].cursor=b},bD:function(a,b){a[H][ca.wa+Sp]=b;a[H].MozUserSelect=b;a.onselectstart=
